...
const mockBids = [
  { id: 1, bidder: "Alice", reputation: 4.8, resources: "10年HR经验 + 行业人脉", resourcesEn: "10yr HR + industry connections", share: "20%", deposit: 50 },
  { id: 2, bidder: "Bob", reputation: 4.5, resources: "职业规划师 + 面试辅导", resourcesEn: "Career planner + interview coaching", share: "15%", deposit: 40 },
  { id: 3, bidder: "Carol", reputation: 4.9, resources: "3次成功转型经验", resourcesEn: "3 successful transitions", share: "25%", deposit: 60 },
];
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          <h2 className="font-display font-semibold text-xl mb-2">
            {language === "zh" ? "30天内完成职场转型计划" : "30-Day Career Transformation Plan"}
          </h2>
          <p className="text-muted-foreground text-sm mb-4">
            {language === "zh" ? "从传统行业转向Web3，需要有经验的伙伴指导" : "Transitioning to Web3, need experienced partner guidance"}
          </p>
          <div className="flex flex-wrap gap-4 text-sm">
            ...
            <span className="flex items-center gap-1 text-muted-foreground">
              <Clock className="w-4 h-4" /> {language === "zh" ? "14天" : "14 days"}
            </span>
            <span className="flex items-center gap-1 text-muted-foreground">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3">
            <h2 className="font-display font-semibold text-lg mb-4">
              {language === "zh" ? `当前竞拍 (${mockBids.length})` : `Current Bids (${mockBids.length})`}
            </h2>
