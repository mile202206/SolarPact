...
import {
  ...
  FileText, CalendarDays, Shield, X
} from "lucide-react";
...
const Growth = () => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-6 relative">
      {/* Decorative art visual */}
      <div className="absolute top-24 right-6 w-[70px] h-[70px] rounded-full overflow-hidden opacity-[0.05] blur-[1px] pointer-events-none">
