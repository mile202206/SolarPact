...
import { Search, Filter, Clock, Coins, Users, ArrowRight, Star, Sparkles, Crown } from "lucide-react";
...
const mockNeeds = [
  { id: 1, title: "30天内完成职场转型计划", titleEn: "30-Day Career Transformation", category: "职场", description: "从传统行业转向Web3，需要有经验的导师指导", descEn: "Transition to Web3 with experienced mentoring", bounty: 200, bids: 5, deadline: "14天", deadlineEn: "14 days", level: "🔥", author: "匿名用户 #3847", authorEn: "Anon #3847", status: "竞拍中" },
  { id: 2, title: "建立每日冥想习惯", titleEn: "Build Daily Meditation Habit", category: "健康", description: "坚持21天每日冥想15分钟", descEn: "21 days of 15-min daily meditation", bounty: 50, bids: 3, deadline: "21天", deadlineEn: "21 days", level: "🌱", author: "匿名用户 #1204", authorEn: "Anon #1204", status: "竞拍中" },
  { id: 3, title: "完成个人品牌打造", titleEn: "Build Personal Brand", category: "自我", description: "从零开始建立社交媒体个人品牌", descEn: "Build social media personal brand from scratch", bounty: 500, bids: 12, deadline: "30天", deadlineEn: "30 days", level: "⛰️", author: "匿名用户 #7721", authorEn: "Anon #7721", status: "进行中" },
  { id: 4, title: "走出一段感情", titleEn: "Overcome a Breakup", category: "婚恋", description: "需要一位有心理咨询经验的伙伴帮助我重建信心", descEn: "Need a partner with counseling experience", bounty: 150, bids: 8, deadline: "28天", deadlineEn: "28 days", level: "🔥", author: "匿名用户 #5529", authorEn: "Anon #5529", status: "竞拍中" },
  { id: 5, title: "学会公开演讲", titleEn: "Master Public Speaking", category: "职场", description: "克服社交恐惧，完成3次公开演讲", descEn: "Overcome social anxiety, complete 3 speeches", bounty: 300, bids: 6, deadline: "45天", deadlineEn: "45 days", level: "⛰️", author: "匿名用户 #9103", authorEn: "Anon #9103", status: "竞拍中" },
  { id: 6, title: "减脂10斤健康计划", titleEn: "Lose 10kg Health Plan", category: "健康", description: "科学饮食+运动，每周打卡记录体脂变化", descEn: "Scientific diet + exercise with weekly tracking", bounty: 100, bids: 4, deadline: "60天", deadlineEn: "60 days", level: "🔥", author: "匿名用户 #2288", authorEn: "Anon #2288", status: "进行中" },
];
...
const Marketplace = () => {
  ...
  const filtered = mockNeeds.filter((n) => {
    ...
    const matchSearch = n.title.includes(searchQuery) || n.description.includes(searchQuery) ||
      (language === "en" && ((n.titleEn || "").toLowerCase().includes(searchQuery.toLowerCase()) || (n.descEn || "").toLowerCase().includes(searchQuery.toLowerCase())));
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-6 relative">
      {/* Decorative cosmic sphere */}
      <div className="absolute top-20 right-8 w-[80px] h-[80px] rounded-full overflow-hidden opacity-[0.06] blur-[1px] pointer-events-none">
        <img src={cosmicSphere} alt="" className="w-full h-full object-cover" />
      </div>
          ...
          {filtered.map((need, i) => (
            ...
            >
              ...
              <h3 className="font-display font-semibold text-lg mb-2 group-hover:text-primary transition-colors">
                {language === "zh" ? need.title : need.titleEn}
              </h3>
              <p className="text-muted-foreground text-sm mb-4 line-clamp-2">
                {language === "zh" ? need.description : need.descEn}
              </p>
              ...
              <div className="flex items-center gap-4 text-sm text-muted-foreground mb-4">
                ...
                <span className="flex items-center gap-1">
                  ...
                  {language === "zh" ? need.deadline : need.deadlineEn}
                </span>
              </div>

              <div className="flex items-center justify-between">
                <span className="text-xs text-muted-foreground">
                  {language === "zh" ? need.author : need.authorEn}
                </span>
                <Link
                  to={`/bid/${need.id}`}
                ...
                >
                  {need.status === "竞拍中" ? t("joinBid") : t("viewProgress")}
