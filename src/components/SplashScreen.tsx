      ...
      {phase !== "done" && (
        ...
        >
          ...
          >
            ...
            {/* Planet core — cosmic GIF */}
            <motion.div
              className="absolute w-[120px] h-[120px] rounded-full z-10 overflow-hidden"
              style={{
                boxShadow: `0 0 50px hsl(var(--primary) / 0.25), 0 0 100px hsl(var(--accent) / 0.12)`,
              }}
              animate={{
                scale: [1, 1.06, 1],
              }}
            ...
            >
              ...
              <div
                ...
                style={{
                  background: "radial-gradient(circle at 35% 30%, hsl(0 0% 100% / 0.08), transparent 50%)",
                }}
              />
              <div
